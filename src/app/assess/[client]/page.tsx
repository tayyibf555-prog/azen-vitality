...
// Public, embeddable Smile Assessment quiz. A friendly single-page form: the
// qualifying questions plus light contact details. On submit it POSTs to the
// public /api/smile-assessment/submit endpoint and shows a band-specific
// thank-you. No auth, no SSR data fetch — the [client] slug is used only to brand
// and to resolve the practice server-side.
        ...
        {result ? (
          ...
          <form onSubmit={submit} className="space-y-7">
            <div className="space-y-1">
              <h1 className="text-2xl text-navy">Let's find your best next step</h1>
