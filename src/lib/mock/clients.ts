...
export const SITES: Site[] = [
  { id: "site-cc", clientId: "vitality", name: "City Centre", timezone: "Europe/London" },
  { id: "site-rv", clientId: "vitality", name: "Riverside", timezone: "Europe/London" },
  { id: "site-ng", clientId: "vitality", name: "Northgate", timezone: "Europe/London" },
];
