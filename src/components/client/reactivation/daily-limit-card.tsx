...
// same rule server-side). A quiet hairline section under the stats: the title
// and today's usage sit on the hairline with the control right-aligned.
        ...
        <div className="flex items-center gap-3">
          ...
          {editing ? (
            ...
            <button
              ...
              disabled={limit === null}
              className="pressable rounded-lg border border-line-strong px-3 py-1.5 text-sm font-semibold text-navy transition-colors hover:bg-card-muted disabled:opacity-50"
            >
              Change
            </button>
          ) : null}
