...
// no SSR data fetch — the slug brands the funnel and resolves the practice. The
// campaign landing page (/assess/<client>/<slug>) reuses the same quiz with
// campaign framing.
...
export default function SmileAssessmentPage() {
  ...
  return <AssessmentQuiz clientSlug={clientSlug} practiceName={practiceName} />;
}
